---
title: getBalance
description: getBalance is a function that returns the balance of that account.
---
...
METHOD: `POST`
API ENDPOINT : https://pro.nocaptchaai.com/solve
...
<CardGrid>
  <Card title="probot" icon="translate"></Card>
  <Card title="amazon" icon="translate"></Card>
  <Card title="omgomg" icon="translate"></Card>
  <Card title="mtcap" icon="translate"></Card>
  <Card title="dell" icon="translate"></Card>
  <Card title="catch" icon="translate"></Card>
  <Card title="webde" icon="translate"></Card>
  <Card title="zefoy" icon="translate"></Card>
  <Card title="caixa" icon="translate"></Card>
  <Card title="oxcheats" icon="translate"></Card>
  <Card title="u1" icon="translate"></Card>
  <Card title="zoho" icon="translate"></Card>
  <Card title="protypers" icon="translate"></Card>
  <Card title="visa1" icon="translate"></Card>
